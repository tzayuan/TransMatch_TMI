'''
LWSA module (Note. including optional Conv. module)
...
class LWSA(nn.Module):
    ...
    def forward(self, x):
        ...
        # for i in out_feats:
        #     print('The shape of out_feats:', i.shape)
        #print('The shape of f0(out_feats[-1]):', out_feats[-1].shape)

        if self.if_transskip:
            f1 = out_feats[-2]
            #print('The shape of f1(out_feats[-2]):', f1.shape)
            f2 = out_feats[-3]
            #print('The shape of f2(out_feats[-3]):', f2.shape)
            f3 = out_feats[-4]
            #print('The shape of f3(out_feats[-4]):', f3.shape)
        else:
            f1 = None
            f2 = None
            f3 = None
...
CONFIGS = {
    'TransMatch_LWSA': configs.get_LWSA_config(),
}
