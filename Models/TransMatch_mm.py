# Compared with TransMatch.py, just the location of the stn function has some different.

import torch.nn as nn
import torch
import transmatch.Conv3dReLU as Conv3dReLU
import transmatch.LWSA as LWSA
import transmatch.LWCA as LWCA
import transmatch.Decoder as Decoder
import transmatch.configs_TransMatch as configs
...
class TransMatch(nn.Module):
    def __init__(self, args):
        ...
        self.stn =SpatialTransformer((192, 224, 192))

    def forward(self, input_fusion):
        moving_Input = input_fusion[:, 0:1, ...]
        fixed_Input = input_fusion[:, 1:, ...]
        ...
        warp = self.stn(moving_Input, flow)
