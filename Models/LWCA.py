'''
LWCA module (Note. including optional Conv. module)
...
class LWCA(nn.Module):
    ...
    def forward(self, x, y):
        moving_fea_4_cross = self.transformer(x, y)
        return moving_fea_4_cross


CONFIGS = {
    'TransMatch_LWCA': configs.get_LWCA_config(),
}
